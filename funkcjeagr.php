...
<?php
    ...
    tabelka3("select avg(zarobki) as myavg, if(imie like '%a', 'Kobiety', 'Mezczyzni') as plec1 from pracownicy group by plec1", "Średnia zarobków kobiet i mężczyzn:", "Średnia", "myavg");
    
    tabelka3("select sum(zarobki) as mysum, if(imie like '%a', 'Kobiety', 'Mezczyzni') as plec1 from pracownicy group by plec1", "Suma zarobków kobiet i mężczyzn:", "Suma", "mysum");
